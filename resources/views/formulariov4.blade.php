...
<form id="registrationForm" class="container mt-5">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="name" name="name" placeholder="ejemplo: Carlos" required>
    </div>
    
    <!-- Surname -->
    <div class="mb-3">
        <label for="ApellidoPaterno" class="form-label">¿Cuál es su Apellido Paterno?</label>
        <input type="text" class="form-control" id="ApellidoPaterno" name="ApellidoPaterno" placeholder="ejemplo: Perez" required>
    </div>

    <!-- Second surname -->
    <div class="mb-3">
        <label for="ApellidoMaterno" class="form-label">¿Cuál es su Apellido Materno?</label>
        <input type="text" class="form-control" id="ApellidoMaterno" name="ApellidoMaterno" placeholder="ejemplo: Morales" required>
    </div>
    ...
    <!-- Address -->
    <div class="mb-3">
        <label for="DireccionArtesano" class="form-label">¿Cuál es su dirección de su Domicilio actual en la ciudad del ALTO?</label>
        <input type="text" class="form-control" id="DireccionArtesano" name="DireccionArtesano" placeholder="ejemplo: calle eulert No 1205 Zona 16 de Julio" required>
    </div>
    ...
    <div class="mb-3">
        ...
        <select id="CIExt" class="form-select" name="CIExt" required>
            <option value="">--Seleccione una opción--</option>
    ...
    <div class="mb-3">
        ...
        <select id="Complemento" class="form-select" name="Complemento" required>
            <option value="">--Seleccione una opción--</option>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="NumeroCelular" name="NumeroCelular" placeholder="ejemplo: 70512346" required>
    </div>
    ...
    <div class="mb-3">
        <label for="DireccionProductiva" class="form-label">¿Cuál es la dirección de la Unidad Productiva Artesanal a la que pertenece?</label>
        <input type="text" class="form-control" id="DireccionProductiva" name="DireccionProductiva" placeholder="ejemplo: calle pascoe Nro2671 zona 16 de julio" required>
    </div>

    <!-- District -->
    <div class="mb-3">
        <label for="DistritoProductiva" class="form-label">¿A qué Distrito Pertenece su Unidad Productiva Artesanal?</label>
        <select id="DistritoProductiva" class="form-select" name="DistritoProductiva" required>
    ...
    <fieldset class="step mb-4" style="display: none;">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="ProductoPrincipal" name="ProductoPrincipal" placeholder="Ejemplo: Muebles de Cocina">
        </div>
        <!-- Secondary Product -->
        <div class="mb-3">
            <label for="ProductoSecundario" class="form-label">¿Cual es el segundo producto que elabora?</label>
            <input type="text" class="form-control" id="ProductoSecundario" name="ProductoSecundario" placeholder="Ejemplo: Chamarras">
        </div>
        <!-- ... -->
    ...
    <div class="mb-3">
        ...
        <select id="Licencia" class="form-select" name="Licencia" required>
            <option value="">--Seleccione una Opción--</option>
            <option value="si">SI</option>
            <option value="no">NO</option>
        </select>
    ...
    <div class="mb-3">
        ...
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="venta" name="ImpuestoGamea" value="venta">
            <label for="venta" class="form-check-label">Patente de puesto de venta</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="productiva" name="ImpuestoGamea" value="productiva">
            <label for="productiva" class="form-check-label">Patente de unidad productiva</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="comercio" name="ImpuestoGamea" value="comercio">
            <label for="comercio" class="form-check-label">Patente de Tienda de comercio prod.</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="feria" name="ImpuestoGamea" value="feria">
            <label for="feria" class="form-check-label">Patente Temporal de Feria</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="ninguno" name="ImpuestoGamea" value="ninguno">
            <label for="ninguno" class="form-check-label">Ninguno</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="otro" name="ImpuestoGamea" value="otro">
